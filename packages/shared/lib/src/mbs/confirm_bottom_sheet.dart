...
Future<bool?> showConfirmBottomSheet({
  ...
  return showModalBottomSheet<bool>(
    ...
    builder: (_) => _ConfirmSheet(title: title, acceptText: acceptText, declineText: declineText),
  );
}

class _ConfirmSheet extends StatelessWidget {
  const _ConfirmSheet({required this.title, required this.acceptText, required this.declineText});
    ...
    return MbsBase(
      ...
      child: Column(
        ...
        children: [
          ...
          AppTextButtonSecondary.large(text: acceptText, onTap: () => context.ext.pop(true)),
