  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: context.ext.colors.white[300], borderRadius: BorderRadius.circular(16)),
        child: Row(
          spacing: 4,
          mainAxisSize: MainAxisSize.min,
          children: [
            FIcons.camera.icon(context, size: 16),
            AppText('Добавить', style: AppTextStyles.bodySmall.copyWith(color: context.ext.colors.black[700])),
          ],
        ),
      ),
    );
