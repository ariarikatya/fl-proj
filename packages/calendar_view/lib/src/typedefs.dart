...
typedef CellBuilder<T extends Object?> =
    Widget Function(
      DateTime date,
...
typedef PageChangeCallback = void Function(DateTime date, CalendarEventData event);
...
typedef DatesPeriodBuilder = Widget Function(List<DateTime> dates);
...
typedef EventFilter<T extends Object?> =
    List<CalendarEventData<T>> Function(DateTime date, List<CalendarEventData<T>> events);

/// Comparator for sorting events.
typedef EventSorter<T extends Object?> = int Function(CalendarEventData<T> a, CalendarEventData<T> b);
