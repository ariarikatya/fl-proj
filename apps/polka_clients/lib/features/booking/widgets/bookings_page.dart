      ...
      child: Column(
        children: [
          TabBar(
            ...
            dividerHeight: 1,
            dividerColor: AppColors.backgroundDisabled,
            isScrollable: true,
            labelStyle: AppTextStyles.bodyMedium.copyWith(color: AppColors.textPrimary, height: 2.5),
            unselectedLabelColor: AppColors.textPlaceholder,
            indicatorAnimation: TabIndicatorAnimation.linear,
            indicator: UnderlineTabIndicator(borderSide: BorderSide(color: AppColors.textSecondary)),
